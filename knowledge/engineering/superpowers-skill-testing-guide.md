---
name: superpowers-skill-testing-guide
summary: Integration testing approach for Claude Code skills using subagents and the Stable Superpowers Skill Integration Testing pattern
