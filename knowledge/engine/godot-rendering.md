...
summary: Godot engine reference for the rendering module — APIs, patterns, and best practices
category: engine
confidence: medium
tags: [game-studios, ccgs, godot, engine-reference, rendering]
...
source_path: docs/engine-reference/godot/modules/rendering.md
