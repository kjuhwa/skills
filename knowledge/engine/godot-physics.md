---
name: godot-physics
summary: Godot engine reference for the physics module — APIs, patterns, and best practices
category: engine
confidence: medium
tags: [game-studios, ccgs, godot, engine-reference, physics]
...
source_path: docs/engine-reference/godot/modules/physics.md
